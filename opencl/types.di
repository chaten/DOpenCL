...
mixin(create_cl_type_enum("DeviceType","CL_DEVICE_TYPE","DEFAULT","CPU","GPU","ACCELERATOR","ALL"));
...
mixin(create_cl_type_enum("DeviceFPConfig","CL_FP","DENORM","INF_NAN","ROUND_TO_NEAREST","ROUND_TO_ZERO","ROUND_TO_INF","FMA","SOFT_FLOAT"));
...
mixin(create_cl_type_enum("DeviceExecCapabilities","CL_EXEC","KERNEL","NATIVE_KERNEL"));

mixin(create_cl_type_enum("CommandQueueProperties","CL_QUEUE","OUT_OF_ORDER_EXEC_MODE_ENABLE","PROFILING_ENABLE"));
...
mixin(create_cl_type_enum("MemFlags","CL_MEM","READ_WRITE","WRITE_ONLY","READ_ONLY","USE_HOST_PTR","ALLOC_HOST_PTR","COPY_HOST_PTR"));
...
mixin(create_cl_type_enum("MapFlags","CL_MAP","READ","WRITE"));
